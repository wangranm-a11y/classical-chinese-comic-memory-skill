...
下面这组图可以直接用于 README、朋友圈、小红书、即刻或项目介绍页。

| 图片 | 用途 |
|---|---|
| `assets/hero-banner.png` | GitHub README 顶部横幅，解释项目核心概念：古文 → 视觉钩子 → 故事链 → 背诵 |
| `assets/workflow.png` | 方法流程图，适合解释“三步做成背诵漫画”：拆句 → 视觉钩子 → 看图背诵 |
| `assets/social-poster.png` | 竖版宣传海报，适合社媒发布、转发和项目预告 |

![三步做成背诵漫画 workflow](assets/workflow.png)
